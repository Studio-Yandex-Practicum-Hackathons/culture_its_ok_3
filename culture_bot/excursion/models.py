...
class DescriptionExhibit(models.Model):
    ...
    text = models.TextField(
        ...
        help_text=('каждая область - это отдельное сообщение '
                   ...
                   'Для текста предусмотрено форматирование, заключите текст в пару тегов для того, чтобы текст стал:'
                   '<u>подчеркнутый текст</u> подчеркнутый'
                   '<del>зачеркнуты текст</del>',
                   '<em>курсив</em>',
                   '<i>курсив</i>',
